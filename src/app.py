...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team skills and compete in interscholastic games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Build endurance and swim laps while learning stroke technique",
        "schedule": "Mondays, Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
        "participants": ["maria@mergington.edu", "troy@mergington.edu"]
    },
    "Art Studio": {
